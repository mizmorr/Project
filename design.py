...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar_2.setGeometry(QtCore.QRect(10, 250, 103, 27))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 21, 271, 111))
        ...
        self.label_29.setGeometry(QtCore.QRect(10, 180, 121, 18))
        self.label_29.setObjectName("label_29")
        self.label_30 = QtWidgets.QLabel(self.tab)
        self.label_30.setGeometry(QtCore.QRect(150, 170, 131, 31))
        ...
        self.label_8.setGeometry(QtCore.QRect(150, 137, 131, 31))
        self.label_8.setText("")
        self.label_8.setObjectName("label_8")
        self.progressBar_3 = QtWidgets.QProgressBar(self.tab_2)
        self.progressBar_3.setGeometry(QtCore.QRect(10, 250, 103, 27))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(11, 21, 271, 111))
        ...
        self.label_27.setGeometry(QtCore.QRect(10, 180, 121, 18))
        self.label_27.setObjectName("label_27")
        self.label_28 = QtWidgets.QLabel(self.tab_2)
        self.label_28.setGeometry(QtCore.QRect(150, 170, 131, 31))
        ...
        self.progressBar_4.setGeometry(QtCore.QRect(20, 280, 103, 27))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 50, 271, 111))
        ...
        self.label_31.setGeometry(QtCore.QRect(10, 220, 121, 18))
        self.label_31.setObjectName("label_31")
        self.label_32 = QtWidgets.QLabel(self.groupBox_2)
        self.label_32.setGeometry(QtCore.QRect(160, 210, 131, 31))
        ...
        self.label_24.setGeometry(QtCore.QRect(150, 95, 131, 31))
        ...
        self.pushButton_9.released.connect(self.btnmid)
    ...
    def btnmid(self):
        ...
        mid = so.MediumDensity
        v = int(self.lineEdit.text())
        param = int(self.lineEdit_2.text())
        self.progressBar_2.setValue(0)
        mid.restype = ctypes.c_void_p
        mid.argtypes=[ctypes.c_int]
        midout = mid(v,param)
        self.progressBar_2.setValue(100)
        midbytes = ctypes.string_at(midout)
        midstring = midbytes.decode('utf-8')
        time2,prestring = strconv(midstring)
        density,midstring=strconv(prestring)
        if midstring=="no such k-core found\n":
                self.label_5.setText("")
        else:
                self.label_5.setText(time2)
        file = open(fname+"/mdens.txt",'w')
        file.write(midstring)
        file.close()
        self.label_30.setText(density)
    ...
    def btnSparse(self):
        ...
        time2,prestring = strconv(spstring)
        density, spstring = strconv(prestring)
        self.label_28.setText(density)
    ...
    def btn_ER(self):
        ...
        time2, prestr = strconv(erstr)
        _,erstr = strconv(prestr)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Execution time"))
        self.label_3.setText(_translate("MainWindow", "Nodes count"))
        self.label_7.setText(_translate("MainWindow", "Parameter"))
        self.label_29.setText(_translate("MainWindow", "Density"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Medium Density"))
        self.label_9.setText(_translate("MainWindow", "Execution time"))
        self.label_4.setText(_translate("MainWindow", "Nodes count"))
        self.label_10.setText(_translate("MainWindow", "Parameter"))
        self.label_27.setText(_translate("MainWindow", "Density"))
        ...
        self.label_11.setText(_translate("MainWindow", "Execution time"))
        ...
        self.label_15.setText(_translate("MainWindow", "Execution time"))
        self.label_20.setText(_translate("MainWindow", "Set parameter"))
        self.label_17.setText(_translate("MainWindow", "Result"))
        self.label_19.setText(_translate("MainWindow", "Execution time"))
        ...
        self.label_23.setText(_translate("MainWindow", "Execution time"))
